...
OUTPUT_DIR="${OUTPUT_DIR:-output/medium_calibration_v3_ocr}"
RUN_DIR="${RUN_DIR:-output/runs/medium_calibration_v3_ocr}"
WORK_DIR="${WORK_DIR:-output/work/medium_calibration_v3_ocr}"
DPI="${DUPE_DPI:-150}"
PROFILES="${DUPE_TESSERACT_PREPROCESSING_PROFILES:-standard}"
OPENAI_OCR_MAX_PAGES="${DUPE_OPENAI_OCR_MAX_PAGES_PER_JOB:-200}"
