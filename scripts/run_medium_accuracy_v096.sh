...
OUTPUT_DIR="${OUTPUT_DIR:-output/medium_calibration_v3_ocr_embed}"
RUN_DIR="${RUN_DIR:-output/runs/medium_calibration_v3_ocr_embed}"
WORK_DIR="${WORK_DIR:-output/work/medium_calibration_v3_ocr_embed}"
DPI="${DUPE_DPI:-150}"
...
EMBEDDING_TOP_K="${DUPE_EMBEDDINGS_CANDIDATE_TOP_K:-10}"
